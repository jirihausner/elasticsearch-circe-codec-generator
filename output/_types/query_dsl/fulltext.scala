...
import com.converted.elasticsearch._types.common.{ Field, Fields, Fuzziness, MinimumShouldMatch, MultiTermQueryRewrite }
import com.converted.elasticsearch._types.Numeric.{ double, float, integer }
import com.converted.elasticsearch._types.Scripting.{ Script }
import com.converted.elasticsearch._types.query_dsl.{ QueryBase }
import com.converted.elasticsearch._types.query_dsl.{ Operator }
