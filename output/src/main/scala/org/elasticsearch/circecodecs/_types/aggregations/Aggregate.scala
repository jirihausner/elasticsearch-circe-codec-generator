...
import org.elasticsearch.circecodecs._types.Geo.{ LatLon }
import org.elasticsearch.circecodecs._types.Numeric.{ double, integer, long }
import org.elasticsearch.circecodecs._types.query_dsl.geo.{ GeoCoordinate, GeoLocation }
import org.elasticsearch.circecodecs._types.Time.{ DateMathTime }
