...
import org.elasticsearch.circecodecs._types.common.{ Field, MinimumShouldMatch }
import org.elasticsearch.circecodecs._types.Geo.{ Distance }
import org.elasticsearch.circecodecs._types.Numeric.{ double, float, long }
...
import org.elasticsearch.circecodecs._types.query_dsl.{ GeoLocation }
