...
import org.elasticsearch.circecodecs._global.search._types.sort.{ SortOrder, Sort }
...
import org.elasticsearch.circecodecs._types.Scripting.{ Script, ScriptField }
import org.elasticsearch.circecodecs._types.aggregations.{ Aggregation }
import org.elasticsearch.circecodecs._types.aggregations.{ Missing }
import org.elasticsearch.circecodecs._types.aggregations.{ DateInterval }
