...
import org.elasticsearch.circecodecs._global.search._types.sort.{ SortOrder }
import org.elasticsearch.circecodecs._spec_utils.Dictionary.{ Dictionary }
import org.elasticsearch.circecodecs._spec_utils.UserDefinedValue.{ UserDefinedValue }
import org.elasticsearch.circecodecs._types.common.{ Field, RelationName, Fields }
import org.elasticsearch.circecodecs._types.Geo.{ GeoDistanceType, DistanceUnit, GeoHashPrecision, GeoTilePrecision }
import org.elasticsearch.circecodecs._types.Numeric.{ integer, float, long, double }
import org.elasticsearch.circecodecs._types.query_dsl.abstractions.{ QueryContainer }
import org.elasticsearch.circecodecs._types.query_dsl.geo.{ GeoLocation, BoundingBox }
import org.elasticsearch.circecodecs._types.Scripting.{ Script }
import org.elasticsearch.circecodecs._types.Time.{ DateString, Time, DateMath }
import org.elasticsearch.circecodecs._types.aggregations.{ GeoBounds }
import org.elasticsearch.circecodecs._types.aggregations.{ Aggregation }
import org.elasticsearch.circecodecs._types.aggregations.{ AggregationContainer, Missing }
