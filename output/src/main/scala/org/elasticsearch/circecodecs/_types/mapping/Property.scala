...
import org.elasticsearch.circecodecs._types.mapping.{ FlattenedProperty }
import org.elasticsearch.circecodecs._types.mapping.{ CoreProperty, JoinProperty, PercolatorProperty, RankFeatureProperty, RankFeaturesProperty }
import org.elasticsearch.circecodecs._types.mapping.{ DynamicMapping }
import org.elasticsearch.circecodecs._types.mapping.{ ConstantKeywordProperty, FieldAliasProperty, HistogramProperty }
