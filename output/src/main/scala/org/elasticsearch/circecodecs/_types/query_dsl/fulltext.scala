...
import org.elasticsearch.circecodecs._types.common.{ Field, Fields, Fuzziness, MinimumShouldMatch, MultiTermQueryRewrite }
import org.elasticsearch.circecodecs._types.Numeric.{ double, float, integer }
...
import org.elasticsearch.circecodecs._types.query_dsl.{ Operator }
