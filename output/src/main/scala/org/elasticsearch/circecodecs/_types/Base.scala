...
import org.elasticsearch.circecodecs._spec_utils.behaviors.{ CommonQueryParameters }
import org.elasticsearch.circecodecs._types.{ Id, IndexName, SequenceNumber, Type, VersionNumber, VersionString }
import org.elasticsearch.circecodecs._types.{ ErrorCause, MainError }
import org.elasticsearch.circecodecs._types.{ integer, long }
import org.elasticsearch.circecodecs._types.{ Result }
import org.elasticsearch.circecodecs._types.{ ShardStatistics }
import org.elasticsearch.circecodecs._types.{ DateString }
