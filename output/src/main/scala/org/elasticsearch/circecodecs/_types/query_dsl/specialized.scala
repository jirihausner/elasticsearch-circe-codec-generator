...
import org.elasticsearch.circecodecs._types.analysis.StopWords.{ StopWords }
import org.elasticsearch.circecodecs._types.common.{ Field, Fields, Id, IndexName, MinimumShouldMatch, Routing, ShapeRelation, Type, VersionNumber, VersionType }
...
import org.elasticsearch.circecodecs._types.Time.{ DateMath, Time }
import org.elasticsearch.circecodecs._types.query_dsl.{ FieldLookup, QueryBase, QueryContainer }
import org.elasticsearch.circecodecs._types.query_dsl.{ GeoCoordinate, GeoShape }
