...
import org.elasticsearch.circecodecs._global.explain.types.{ Explanation }
import org.elasticsearch.circecodecs._spec_utils.Dictionary.{ Dictionary }
import org.elasticsearch.circecodecs._spec_utils.UserDefinedValue.{ UserDefinedValue }
import org.elasticsearch.circecodecs._types.common.{ Field, Fields, Id, IndexName, Name, SequenceNumber, Type, VersionNumber }
...
import org.elasticsearch.circecodecs._global.search._types.{ FieldCollapse }
import org.elasticsearch.circecodecs._global.search._types.{ Highlight }
import org.elasticsearch.circecodecs._global.search._types.{ Sort, SortResults }
import org.elasticsearch.circecodecs._global.search._types.{ SourceFilter }
