...
import org.elasticsearch.circecodecs.types.aggregations.pipeline.{ InferenceConfigContainer }
import org.elasticsearch.circecodecs.types.common.{ Field, Id, Name, VersionString }
