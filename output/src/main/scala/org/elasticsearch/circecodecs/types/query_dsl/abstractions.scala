...
import org.elasticsearch.circecodecs.spec_utils.Dictionary.{ SingleKeyDictionary }
import org.elasticsearch.circecodecs.types.common.{ Field, Id, IndexName, Routing }
import org.elasticsearch.circecodecs.types.Numeric.{ float, long }
import org.elasticsearch.circecodecs.types.query_dsl.{ BoolQuery, BoostingQuery, ConstantScoreQuery, DisMaxQuery, FunctionScoreQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ CommonTermsQuery, IntervalsQuery, MatchBoolPrefixQuery, MatchPhrasePrefixQuery, MatchPhraseQuery, MatchQuery, MultiMatchQuery, QueryStringQuery, SimpleQueryStringQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ GeoBoundingBoxQuery, GeoDistanceQuery, GeoPolygonQuery, GeoShapeQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ HasChildQuery, HasParentQuery, NestedQuery, ParentIdQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ MatchAllQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ MatchNoneQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ SpanContainingQuery, SpanFieldMaskingQuery, SpanFirstQuery, SpanMultiTermQuery, SpanNearQuery, SpanNotQuery, SpanOrQuery, SpanTermQuery, SpanWithinQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ DistanceFeatureQuery, MoreLikeThisQuery, PercolateQuery, PinnedQuery, RankFeatureQuery, ScriptQuery, ScriptScoreQuery, ShapeQuery }
import org.elasticsearch.circecodecs.types.query_dsl.{ ExistsQuery, FuzzyQuery, IdsQuery, PrefixQuery, RangeQuery, RegexpQuery, TermQuery, TermsQuery, TermsSetQuery, TypeQuery, WildcardQuery }
