...
import org.elasticsearch.circecodecs.types.Geo.{ Distance, GeoDistanceType, GeoShapeRelation, LatLon }
import org.elasticsearch.circecodecs.types.Numeric.{ double }
import org.elasticsearch.circecodecs.types.query_dsl.{ FieldLookup, QueryBase }
