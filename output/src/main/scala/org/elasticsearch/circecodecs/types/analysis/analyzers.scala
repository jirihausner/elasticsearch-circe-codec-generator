...
import org.elasticsearch.circecodecs.types.analysis.{ Language, SnowballLanguage }
import org.elasticsearch.circecodecs.types.analysis.{ StopWords }
import org.elasticsearch.circecodecs.types.analysis.{ NoriDecompoundMode }
