...
import org.elasticsearch.circecodecs.types.common.{ Field, RelationName, Fields }
import org.elasticsearch.circecodecs.types.Geo.{ GeoDistanceType, DistanceUnit, GeoHashPrecision, GeoTilePrecision }
import org.elasticsearch.circecodecs.types.Numeric.{ integer, float, long, double }
import org.elasticsearch.circecodecs.types.query_dsl.abstractions.{ QueryContainer }
import org.elasticsearch.circecodecs.types.query_dsl.geo.{ GeoLocation, BoundingBox }
import org.elasticsearch.circecodecs.types.Scripting.{ Script }
import org.elasticsearch.circecodecs.types.Time.{ DateString, Time, DateMath }
import org.elasticsearch.circecodecs.types.aggregations.{ GeoBounds }
