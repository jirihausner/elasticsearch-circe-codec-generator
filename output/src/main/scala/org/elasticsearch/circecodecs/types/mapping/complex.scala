...
import org.elasticsearch.circecodecs.types.common.{ PropertyName }
import org.elasticsearch.circecodecs.types.Numeric.{ double, integer }
import org.elasticsearch.circecodecs.types.mapping.{ CorePropertyBase, IndexOptions }
import org.elasticsearch.circecodecs.types.mapping.{ DynamicMapping }
import org.elasticsearch.circecodecs.types.mapping.{ Property, PropertyBase }
