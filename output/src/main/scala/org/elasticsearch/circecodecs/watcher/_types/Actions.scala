...
import org.elasticsearch.circecodecs._types.common.{ HttpHeaders, Id, IndexName, Type, VersionNumber }
import org.elasticsearch.circecodecs._types.Numeric.{ integer }
import org.elasticsearch.circecodecs._types.Result.{ Result }
import org.elasticsearch.circecodecs._types.Time.{ DateString }
import org.elasticsearch.circecodecs.watcher._types.{ HttpInputRequestDefinition }
